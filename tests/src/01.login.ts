...
test.beforeAll(async ({ browser }, testInfo) => {
  ...
  await page.goto('http://fakeauth-test:3001/login?clientId=dosgato-admin-test&returnUrl=http%3A%2F%2Fdosgato-admin-test%3A3000%2F.admin&requestedUrl=http%3A%2F%2Fdosgato-admin-test%3A3000%2F.admin%2F')
