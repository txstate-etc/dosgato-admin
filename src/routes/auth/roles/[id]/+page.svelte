...
<div class="vertical-list">
  <DetailPanel header='Basic Information' headerColor={panelHeaderColor} button={ $store.role.permissions.rename ? { icon: pencilIcon, onClick: () => { modal = 'editbasic' }, hiddenLabel: 'Edit Basic Information' } : undefined }>
    <DetailPanelSection>
      <div class="row">
  ...
  {#if $store.role.directGroups.length || $store.role.indirectGroups.length}
    <DetailPanel header='Groups' headerColor={panelHeaderColor}>
      <DetailPanelSection>
        <StyledList>
  ...
  <DetailPanel header='Users' headerColor={panelHeaderColor} button={{ icon: plusIcon, onClick: () => { modal = 'assigntouser' }, hiddenLabel: 'Assign this role to a user' }}>
    <DetailPanelSection>
      <StyledList>
  ...
  <DetailPanel header='Page Rules' headerColor={panelHeaderColor} button={{ icon: plusIcon, onClick: () => { modal = 'addpagerule' }, hiddenLabel: 'Add Page Rule' }}>
    <DetailPanelSection>
  ...
  <DetailPanel header='Asset Rules' headerColor={panelHeaderColor} button={{ icon: plusIcon, onClick: () => { modal = 'addassetrule' }, hiddenLabel: 'Add Asset Rule' }}>
    <DetailPanelSection>
  ...
  <DetailPanel header='Data Rules' headerColor={panelHeaderColor} button={{ icon: plusIcon, onClick: () => { modal = 'adddatarule' }, hiddenLabel: 'Add Data Rule' }}>
    <DetailPanelSection>
  ...
  <DetailPanel header='Global Rules' headerColor={panelHeaderColor} button={$store.role.globalRules.length < 1 ? { icon: plusIcon, onClick: () => { modal = 'addglobalrule' }, hiddenLabel: 'Add Global Rule' } : undefined}>
    <DetailPanelSection>
  ...
  <DetailPanel header='Site Rules' headerColor={panelHeaderColor} button={{ icon: plusIcon, onClick: () => { modal = 'addsiterule' }, hiddenLabel: 'Add Site Rule' }}>
    <DetailPanelSection>
  ...
  <DetailPanel header='Template Rules' headerColor={panelHeaderColor} button={{ icon: plusIcon, onClick: () => { modal = 'addtemplaterule' }, hiddenLabel: 'Add Template Rule' }}>
    <DetailPanelSection>
